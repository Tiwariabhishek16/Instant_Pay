...
public class RemitterProfileData {
    ...
    private String limitIncreaseOffer;
    private String allowProfileUpdate;
    private String limitDetails;
    private String otpReference;
    private RemitterProfileDetails profileDetails;
	...
	public String getLimitIncreaseOffer() {
		return limitIncreaseOffer;
	}
	public void setLimitIncreaseOffer(String limitIncreaseOffer) {
		this.limitIncreaseOffer = limitIncreaseOffer;
	}
	public String getAllowProfileUpdate() {
		return allowProfileUpdate;
	}
	public void setAllowProfileUpdate(String allowProfileUpdate) {
		this.allowProfileUpdate = allowProfileUpdate;
	}
	public String getLimitDetails() {
		return limitDetails;
	}
	public void setLimitDetails(String limitDetails) {
		this.limitDetails = limitDetails;
	}
	public RemitterProfileDetails getProfileDetails() {
		return profileDetails;
	}
	public void setProfileDetails(RemitterProfileDetails profileDetails) {
